...
class Adafruit_LSM9DS0_RFDUINO;

/* Pointer to member functions for read, get event, and get sensor.  These are used */
/* by the Adafruit_LSM9DS0_RFDUINO::Sensor class to read and retrieve individual sensors. */
typedef void (Adafruit_LSM9DS0_RFDUINO::*lsm9ds0_read_func)(void);
typedef void (Adafruit_LSM9DS0_RFDUINO::*lsm9ds0_get_event_func)(sensors_event_t*, uint32_t);
typedef void (Adafruit_LSM9DS0_RFDUINO::*lsm9ds0_get_sensor_func)(sensor_t*);

class Adafruit_LSM9DS0_RFDUINO
{
  public:
    Adafruit_LSM9DS0_RFDUINO ( int32_t sensorID = 0 );
    Adafruit_LSM9DS0_RFDUINO ( int8_t xmcs, int8_t gcs, int32_t sensorID = 0 );
    Adafruit_LSM9DS0_RFDUINO ( int8_t clk, int8_t miso, int8_t mosi, int8_t xmcs, int8_t gcs, int32_t sensorID = 0 );
    ...
    public:
      ...
      {}
      Sensor(Adafruit_LSM9DS0_RFDUINO* parent, lsm9ds0_read_func readFunc, 
    ...
    private:
      Adafruit_LSM9DS0_RFDUINO* _parent;
